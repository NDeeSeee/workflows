...
s:about: |
  usage: PlotFancySpectratype [options] input_name output_prefix
  -h                         display help message
      --plot-type <pdf|png>   Plot output format [default=pdf]
  -t,--top <arg>             Number of top clonotypes to present on the
                              histogram. Values > 20 are not allowed, as
                              they would make the plot legend unreadable.
                              [default = 10]