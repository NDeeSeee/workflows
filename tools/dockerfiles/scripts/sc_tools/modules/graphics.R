...
D40_COLORS <- c(
  ...
  "#F4A261", "#264653", "#E76F51", "#2A9D8F", "#E9C46A", "#A47E1B", "#D38AA2", "#5E6472",
  "#8F5F9C", "#6B4226", "#79A7D3", "#FF6F61", "#FFD166", "#06D6A0", "#118AB2", "#073B4C",
  "#A26769", "#D4A5A5", "#264653", "#457B9D", "#1D3557", "#2A9D8F", "#E63946", "#F1FAEE",
  "#A8DADC", "#F4A261", "#D8A47F", "#CA7E8D", "#8B8C89", "#EAE0D5", "#0A9396", "#EE9B00",
  "#BB3E03", "#AE2012", "#A7C957", "#52796F", "#DDA15E", "#BC6C25", "#E5989B", "#B5838D",
  "#B56576", "#6D597A", "#4F4A45", "#CDB4DB", "#FFC8DD", "#FFAFCC", "#BDE0FE", "#A2D2FF",
  "#FFB703", "#FB8500", "#219EBC", "#023047", "#8ECAE6", "#005F73", "#0A9396", "#94D2BD",
  "#E9D8A6", "#EE9B00", "#CA6702", "#BB3E03", "#AE2012", "#9B2226", "#B1A7A6", "#735751",
  "#6D6875", "#4A4E69", "#22223B", "#9A8C98", "#C9ADA7", "#E4C1F9", "#F7A072", "#F9C74F",
  "#A7C957", "#B7B7A4", "#6A0572", "#AB83A1", "#BF4E30", "#8D99AE", "#EF476F", "#2B2D42"
)
