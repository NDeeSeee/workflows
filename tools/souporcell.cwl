...
inputs:
  ...
  barcodes_tsv_file:
    ...
    doc: |
      ...
      generated by Cell Ranger Count (if run ARC then use GEX matrices)
  ...
  clusters_count:
    ...
    inputBinding:
      ...
      prefix: "--clusters"
    doc: |
      Number of clusters to detect. The number of genotypes to identify.
...
outputs:
  ...
  genotype_cluster_tsv_file:
    ...
    doc: "Cellurar barcodes file with clusters assigned by genotype"

  genotype_cluster_vcf_file:
    type: File
    outputBinding:
      glob: "./souporcell/cluster_genotypes.vcf"
    doc: "VCF file with genotypes for each cluster for each variant in the input vcf from Freebayes"
